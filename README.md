...
<sup>By [Esoteric Enderman](https://enderman.dev), licensed under [CC BY-SA-4.0](./LICENSE), generated from [Template Word Document Repository](https://github.com/EsotericTemplates/template-word-document-repository) [1.0.1](https://github.com/EsotericTemplates/template-word-document-repository/tree/1.0.1)</sup>
