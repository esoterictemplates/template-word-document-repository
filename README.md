...
<sup>By [Esoteric Enderman](https://enderman.dev), licensed under [CC BY-SA-4.0](./LICENSE), generated from [Template Zip File Repository](https://github.com/EsotericTemplates/template-zip-file-repository) [1.0.1](https://github.com/EsotericTemplates/template-zip-file-repository/tree/1.0.1)</sup>
