...
<sup>By [Esoteric Enderman](https://enderman.dev), licensed under [CC-BY-SA-4.0](./LICENSE), generated from [Template Document Repository](https://github.com/EsotericTemplates/template-document-repository) [1.0.0](https://github.com/EsotericTemplates/template-document-repository/tree/1.0.0)</sup>

[![Repository Size](https://img.shields.io/github/repo-size/EsotericTemplates/template-document-repository)](https://github.com/EsotericTemplates/template-document-repository) [![Language Count](https://img.shields.io/github/languages/count/EsotericTemplates/template-document-repository)](https://github.com/EsotericTemplates/template-document-repository) [![Top Language](https://img.shields.io/github/languages/top/EsotericTemplates/template-document-repository?label=top%20language)](https://github.com/EsotericTemplates/template-document-repository) [![GitHub Issues](https://img.shields.io/github/issues/EsotericTemplates/template-document-repository)](https://github.com/EsotericTemplates/template-document-repository/issues) [![GitHub Stars](https://img.shields.io/github/stars/EsotericTemplates/template-document-repository)](https://github.com/EsotericTemplates/template-document-repository/stargazers) [![GitHub Forks](https://img.shields.io/github/forks/EsotericTemplates/template-document-repository)](https://github.com/EsotericTemplates/template-document-repository/forks)
